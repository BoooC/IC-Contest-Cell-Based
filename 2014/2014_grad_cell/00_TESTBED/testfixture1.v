...
module testfixture1;
	...
	`define Pattern "../00_TESTBED/dat/Pattern.dat"
	`define Stimulus "../00_TESTBED/dat/Stimulus.dat"
	`define Expected "../00_TESTBED/dat/Expected_so.dat"
	`define Pat_num 99
	`define Exp_num 1871
	`define Pixel "../00_TESTBED/dat/Expected_pixel.dat"
	`define odd1 "../00_TESTBED/dat/Expected_odd_1.dat"
	`define odd2 "../00_TESTBED/dat/Expected_odd_2.dat"
	`define odd3 "../00_TESTBED/dat/Expected_odd_3.dat"
	`define odd4 "../00_TESTBED/dat/Expected_odd_4.dat" 
	`define even1 "../00_TESTBED/dat/Expected_even_1.dat"
	`define even2 "../00_TESTBED/dat/Expected_even_2.dat"
	`define even3 "../00_TESTBED/dat/Expected_even_3.dat"
	`define even4 "../00_TESTBED/dat/Expected_even_4.dat"
...
initial begin
  ...
  `endif
  `ifdef GATE
    $sdf_annotate("STI_DAC_SYN.sdf", u_rtl);
    $fsdbDumpfile("STI_DAC_SYN.fsdb");
    $fsdbDumpvars();    
  `endif
end
