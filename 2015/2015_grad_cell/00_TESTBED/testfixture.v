...
`define	central_pattern 					"../00_TESTBED/dat/Central_pattern.dat"
`define radius_pattern 						"../00_TESTBED/dat/Radius_pattern.dat"
`define candidate_result_Length 			"../00_TESTBED/dat/candidate_result_Length.dat"
`define candidate_united_result_Length 		"../00_TESTBED/dat/candidate_united_result_Length.dat"
`define candidate_diff_result_Length 		"../00_TESTBED/dat/candidate_diff_result_Length.dat"
`define candidate_intersect_result_Length 	"../00_TESTBED/dat/candidate_intersect_result_Length.dat"
...
initial begin
  ...
  `endif
  `ifdef GATE
    $sdf_annotate("SET_SYN.sdf", u_set);
