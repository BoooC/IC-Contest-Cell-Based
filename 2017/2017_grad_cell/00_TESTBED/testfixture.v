...
`ifdef TB1
	`define PAT        	"../00_TESTBED/dat/Geometry_sti.dat"    
	`define FWEXP     	"../00_TESTBED/dat/Geometry_fwexp.dat"  
	`define BCEXP       "../00_TESTBED/dat/Geometry_bcexp.dat"      
`elsif TB2
	`define PAT        	"../00_TESTBED/dat/ICC17_sti.dat"    
	`define FWEXP       "../00_TESTBED/dat/ICC17_fwexp.dat"
	`define BCEXP       "../00_TESTBED/dat/ICC17_bcexp.dat"
`endif
