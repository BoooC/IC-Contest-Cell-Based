...
`ifdef tb1
  `define PAT "../00_TESTBED/pattern1.dat"
  `define EXP "../00_TESTBED/golden1.dat"
`endif

`ifdef tb2
  `define PAT "../00_TESTBED/pattern2.dat"
  `define EXP "../00_TESTBED/golden2.dat"
`endif

`ifdef tb3
  `define PAT "../00_TESTBED/pattern3.dat"
  `define EXP "../00_TESTBED/golden3.dat"
`endif
