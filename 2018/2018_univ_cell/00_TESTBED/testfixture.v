...
`ifdef tb1
  `define EXPECT 	"../00_TESTBED/tb1_goal.dat"
  `define CMD 		"../00_TESTBED/cmd1.dat"
  `define IMAGE 	"../00_TESTBED/image1.dat"
`endif

`ifdef tb2
  `define EXPECT 	"../00_TESTBED/tb2_goal.dat"
  `define CMD 		"../00_TESTBED/cmd2.dat"
  `define IMAGE 	"../00_TESTBED/image2.dat"
`endif

`ifdef tb3
  `define EXPECT 	"../00_TESTBED/tb3_goal.dat"
  `define CMD 		"../00_TESTBED/cmd3.dat"
  `define IMAGE 	"../00_TESTBED/image3.dat"
`endif
...
initial begin
  ...
  `endif
  `ifdef GATE
    $sdf_annotate("LCD_CTRL_SYN.sdf", LCD_CTRL);
    $fsdbDumpfile("LCD_CTRL_SYN.fsdb");
    $fsdbDumpvars();    
  `endif
end
