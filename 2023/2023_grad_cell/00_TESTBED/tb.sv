...
`ifdef P1
    string PAT [1] = {"../00_TESTBED/img1.pattern"};
    parameter pat_number = 1;
`elsif P2
    string PAT [1] = {"../00_TESTBED/img2.pattern"};
    parameter pat_number = 1;
`elsif P3
    string PAT [1] = {"../00_TESTBED/img3.pattern"};
    parameter pat_number = 1;
`elsif P4
    string PAT [1] = {"../00_TESTBED/img4.pattern"};
    parameter pat_number = 1;
`elsif P5
    string PAT [1] = {"../00_TESTBED/img5.pattern"};
    parameter pat_number = 1;
`elsif P6
    string PAT [1] = {"../00_TESTBED/img6.pattern"};
    parameter pat_number = 1;
`else
    string PAT [6] = {"../00_TESTBED/img1.pattern",
					  "../00_TESTBED/img2.pattern",
					  "../00_TESTBED/img3.pattern",
					  "../00_TESTBED/img4.pattern",
					  "../00_TESTBED/img5.pattern",
					  "../00_TESTBED/img6.pattern"};
