...
genvar gen_i;
generate
    for (gen_i = 0; gen_i < 40; gen_i = gen_i + 1) begin
...
wire [5:0] inside_count = is_inside[0]  + is_inside[1]  + is_inside[2]  + is_inside[3]  + is_inside[4]  + is_inside[5]  + is_inside[6]  + is_inside[7]  + 
                          is_inside[8]  + is_inside[9]  + is_inside[10] + is_inside[11] + is_inside[12] + is_inside[13] + is_inside[14] + is_inside[15] +
                          is_inside[16] + is_inside[17] + is_inside[18] + is_inside[19] + is_inside[20] + is_inside[21] + is_inside[22] + is_inside[23] +
                          is_inside[24] + is_inside[25] + is_inside[26] + is_inside[27] + is_inside[28] + is_inside[29] + is_inside[30] + is_inside[31] +
                          is_inside[32] + is_inside[33] + is_inside[34] + is_inside[35] + is_inside[36] + is_inside[37] + is_inside[38] + is_inside[39];

wire update_flag = inside_count >= opt_count;
...
always @(posedge CLK) begin
	...
	else if (current_c_done & inside_count > opt_count) begin
		c_update_flag <= 1'b1;
	end
end
