...
initial begin
  ...
  `endif
  `ifdef GATE
    $sdf_annotate("Bicubic_SYN.sdf", u_Bicubic);
    $fsdbDumpfile("Bicubic_SYN.fsdb");
    $fsdbDumpvars();    
...
`ifdef P1
    string PAT [1] = {"../00_TESTBED/pattern1"};
    parameter pat_number = 1;
`elsif P2
    string PAT [1] = {"../00_TESTBED/pattern2"};
    parameter pat_number = 1;
`elsif P3
    string PAT [1] = {"../00_TESTBED/pattern3"};
    parameter pat_number = 1;
`else
    string PAT [3] = {"../00_TESTBED/pattern1",
					  "../00_TESTBED/pattern2",
					  "../00_TESTBED/pattern3"};
