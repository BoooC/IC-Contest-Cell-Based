...
// data gating
wire signed [15:0] cubic_in = (count == 'd2) ? x_frac : 'sd0;
...
wire one_hor_done  = count == 'd9 | count == 'd13 |  count == 'd17 |  count == 'd21 | (direct_wb_x & count >= 'd2);

wire count_x_done = (count_x + 'd1) == TW;
wire count_y_done = (count_y + 'd1) == TH;

wire direct_wb = direct_wb_x & direct_wb_y;
wire hor_done = (count == 'd21) | direct_wb | (direct_wb_x & count == 'd5);
