...
| Year | Project Name                | Clock Period (ns) | Simulation Cycle A Grade Standard | Simulation Cycle My Spec | Area (um²) A Grade Standard | Area (um²) My Spec |
|------|-----------------------------|-------------------|-----------------------------------|--------------------------|-----------------------------|--------------------|
| 2023 | LASER                       | < 8               |                                   | 4-Proc: 112,894<br>8-Proc: 56,574 | < 37,000                  | 4-Proc: 23,614.2<br>8-Proc: 28,246.4 |
